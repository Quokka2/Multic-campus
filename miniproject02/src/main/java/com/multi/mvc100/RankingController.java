...
//	}
	...
	public List<Object> list1(Model model) {
		List<Object> list = dao.list1();
		model.addAttribute("list", list);
		return list;
	}
	
	@RequestMapping("list6")
	public List<Object> list6(String storeAddress , Model model) {
		List<Object> list = dao.list(storeAddress);
